        ...
        <el-table style="margin:10px 0px" border :data="records">
          ...
          <el-table-column label="SPU操作">
            <template #="{ row, $index }">
              ...
              <el-button @click="updateSpu(row)" type="primary" size="small" icon="Edit" title="修改SKU"></el-button>
              <el-button @click="findSku(row)" type="primary" size="small" icon="View" title="查看SKU列表"></el-button>
...
// 场景的数据；
let scene = ref<number>(0)  // 0显示已有的spu   1添加或修改已有的spu   2：添加sku
// 分页器默认页码
